...
Unlike traditional batch frameworks, Flink treats **streaming as the primary execution model**. Batch processing is simply considered a special case of bounded streams.
