...
3. Estimate
   ...
   - Example Assumptions:
     ...
     - Estimations:
       - Example:
         - QPS: (daily*active_user * action / 24 \_ 3600)
         - Storage: (daily*active_user * action \_ 1MB \* time_store)
...
Link: [https://anduckhmt1406.site/leadership-amazon/](https://anduckhmt1406.site/leadership-amazon/)
