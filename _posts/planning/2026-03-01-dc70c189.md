...
Cái First Principle Thinking này ngắn gọn là tư duy “Building Blocks” ⇒ “Hãy giải quyết tất cả các vấn đề ở tất cả các blocks của System đó”, từ đầu cổng vào: API Gateway, Load Balancing đến phần lưu data quan trọng như: Server, Database, Cache,… thậm chí ở mọi block hay third-party liên quan, không bị bias theo template có sẵn.
